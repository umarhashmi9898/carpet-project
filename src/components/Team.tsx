  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              {/* Card */}
              <motion.div 
                className={`relative bg-white/5 backdrop-blur-xl border border-yellow-500/20 rounded-3xl p-6 sm:p-8 text-center transition-all duration-500 h-full group-hover:${member.borderColor} group-hover:bg-white/10`}
                whileHover={{ 
                  y: -12,
                  scale: 1.03,
                  rotateY: 5,
              ...
              >
                ...
                <motion.div 
                  className={`w-24 h-24 sm:w-28 sm:h-28 bg-gradient-to-r ${member.iconBg} backdrop-blur-sm border border-yellow-500/30 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg relative overflow-hidden`}
                  whileHover={{ 
                    scale: 1.15, 
                    rotate: 10,
                ...
                >
                  ...
                  {/* Floating Icon */}
                  <motion.div
                    className="absolute -top-2 -right-2 w-8 h-8 bg-white/10 backdrop-blur-md rounded-full border border-yellow-500/30 flex items-center justify-center"
        ...
        >
          <motion.div
            className="bg-white/5 backdrop-blur-xl border border-yellow-500/20 rounded-3xl p-6 sm:p-8 max-w-4xl mx-auto"
            whileHover={{ scale: 1.02 }}
