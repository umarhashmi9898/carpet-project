...
const reviews: Review[] = [
  ...
  },
  {
    ...
    location: 'Birmingham, England',
    rating: 5,
    text: 'Amazing hybrid staircase installation! The combination of laminate and carpet looks absolutely stunning. Professional service from start to finish. Highly recommend SYN Carpets.',
    service: 'Hybrid Laminate Design',
    image: '/6.jpg',
    projectImage: '/6.jpg',
    color: '#7C3AED',
  ...
  },
  {
    ...
    location: 'Birmingham, England',
    rating: 5,
    text: 'Contemporary hybrid staircase exceeded our expectations. The modern design perfectly complements our home. Excellent craftsmanship and attention to detail throughout the project.',
    service: 'Contemporary Hybrid Installation',
    image: '/7.jpg',
    projectImage: '/7.jpg',
    color: '#059669',
  ...
  },
  {
    ...
    location: 'Birmingham, England',
    rating: 5,
    text: 'Beautiful warm carpet installation that transformed our staircase completely. The quality is exceptional and the team was incredibly professional. Couldn\'t be happier with the results.',
    service: 'Warm Tone Carpet Installation',
    image: '/8.jpg',
    projectImage: '/8.jpg',
    color: '#DC2626',
  ...
  },
  {
    ...
    location: 'Birmingham, England',
    rating: 5,
    text: 'Elegant navy carpet runner looks absolutely perfect! The contrasting trim adds such a sophisticated touch. Professional installation and excellent customer service throughout.',
    service: 'Elegant Navy Carpet Runner',
    image: '/9.jpg',
    projectImage: '/9.jpg',
    color: '#1E40AF',
  ...
  },
  {
    ...
    location: 'Birmingham, England',
    rating: 5,
    text: 'Professional hybrid staircase installation was flawless. The combination of materials creates such a unique and stylish look. Expert workmanship and great value for money.',
    service: 'Professional Hybrid Staircase',
    image: '/10.jpg',
    projectImage: '/10.jpg',
    color: '#7C2D12',
