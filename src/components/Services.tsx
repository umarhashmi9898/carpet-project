...
const services = [
  ...
  {
    icon: Layers,
    title: 'Durable Laminate',
    description: 'High-quality laminate flooring that offers the beauty of hardwood with superior durability.',
    features: ['Water Resistant', 'Scratch Proof', 'Easy Installation', 'Long Lasting'],
  ...
  },
  {
    icon: Palette,
    title: 'Stylish Lino',
    description: 'Modern linoleum flooring solutions that provide style, comfort, and practicality.',
    features: ['Eco Friendly', 'Easy Clean', 'Comfort Underfoot', 'Design Variety'],
    image: 'https://images.pexels.com/photos/1125130/pexels-photo-1125130.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=1',
